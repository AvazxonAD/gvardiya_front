...
function Header() {
  ...
  return (
    <header className="bg-card border-b border-border shadow-[0px_1px_12px_0px_#00000026] w-full flex justify-center h-[100%]">
        ...
        <div className="flex gap-6 items-center">
          ...
          <div className="relative">
            <button
              ...
              className="text-[14px] bg-muted w-[72px] h-[37px] leading-[16.94px] rounded text-foreground flex justify-center items-center"
            >
            ...
            <div
              ...
              } absolute top-[37px] bg-muted transition-all duration-300 rounded-none h-[85px] w-[68px] items-center justify-center border border-border shadow-[0px_1px_4px_0px_#00000026]`}
            >
              <div className="flex flex-col gap-2 text-[14px] text-foreground leading-[16.94px]">
                {language.map((e: any) => (
                  <span
                    key={e.id}
                    onClick={() => {
                    ...
                    className={`cursor-pointer hover:text-muted-foreground hover:font-[600] ${
                      e.id === selectedValue && "text-muted-foreground font-[600]"
                    }`}
                  >
                    {e.text}
                  </span>
          ...
          >
            <button className="w-[32px] h-[32px] rounded-none border border-border flex justify-center items-center">
              <div>
                {user.image && !imageError ? (
                  <img
                    src={baseUri + user.image}
                    alt={user.fio}
                    className="w-full h-full rounded-none mx-auto"
          ...
          <div
            ...
            className="w-[52px] h-[52px] p-2 rounded-2xl border border-border justify-center items-center gap-2.5 inline-flex"
          >
            <svg
              width={24}
              height={24}
      ...
      {isModalOpen && (
        <div className="fixed inset-0 bg-[#00000066] flex items-center justify-center z-50">
          <div className="bg-card rounded-none w-[460px] h-[474px] flex justify-center items-center">
            <div className="w-[70%] mx-auto">
              <div className="flex justify-between mb-8 w-full items-center">
                <h2 className="text-foreground font-[500] text-[20px] leading-[24.2px]">
