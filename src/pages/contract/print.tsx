...
const ContractForPrint = React.forwardRef<
  HTMLDivElement,
  ContractForPrintProps
>(({ data }, ref) => {
  return (
        ...
        <tbody>
          {data?.data.map((item, index) => (
            ...
            >
              ...
              <td className="border border-gray-400 px-2 py-1">
                {formatSum(item.discount_money)}
              </td>
              <td className="border border-gray-400 px-2 py-1">
                {formatSum(item.summa)}
              </td>
              <td className="border border-gray-400 px-2 py-1">
                {formatSum(item.result_summa)}
              </td>
              <td className="border border-gray-400 px-2 py-1">
                {formatSum(item.kridit)}
              </td>
              <td className="border border-gray-400 px-2 py-1">
                {formatSum(item.debit)}
              </td>
              <td className="border border-gray-400 px-2 py-1">
          ...
          <tr className={"bg-white font-[700]"}>
