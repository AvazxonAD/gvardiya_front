...
export default function ContractsModal({ isOpen, onClose, type, regionId }: ContractsModalProps) {
                  ...
                  {contracts.length === 0 ? (
                    ...
                    contracts.map((c, i) => (
                      <tr key={c.id} className="transition hover:opacity-80"
                        ...
                        <td className="px-4 py-3 text-[var(--dash-text-secondary)] w-[140px]">{c.region_name}</td>
