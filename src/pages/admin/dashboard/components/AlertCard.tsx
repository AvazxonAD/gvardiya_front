...
export default function AlertCard({ redData, from, to, regionId }: AlertCardProps) {
  ...
  const handleExcel = () => {
    ...
    // Token bilan fetch qilib blob sifatida yuklash
    fetch(url, {
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1">
            ...
            <p className="text-[11px] text-[var(--dash-text-secondary)] leading-snug mt-1">
              Tizim avtomatik ravishda qizil chegaraga tushgan xodimlarni aniqlaydi.
            </p>
          </div>
        </div>
            ...
            <table className="w-full text-left text-sm whitespace-nowrap">
              <thead className="sticky top-0 z-10" style={{ background: "var(--dash-table-header-bg)", borderBottom: "1px solid var(--dash-table-border)" }}>
                <tr className="text-[var(--dash-text-secondary)] uppercase text-[11px]">
                  ...
                  <th className="px-4 py-3 font-semibold min-w-[130px]">Viloyat</th>
