const steps = [
  ...
  },
  {
    ...
    iconBg: "bg-primary/20",
    iconColor: "text-primary",
    cardExtra: "border-primary/30/30 shadow-[0_0_10px_rgba(59,130,246,0.1)]",
    icon: (
      ...
      <div className="flex flex-col md:flex-row items-center justify-between gap-[8px]">
        {steps.map((step, i) => (
          <div key={i} className="contents">
            ...
            >
              <div className={`w-8 h-8 rounded-none ${step.iconBg} flex items-center justify-center mr-3 ${step.iconColor}`}>
