                    ...
                    <div className="bg-white p-6 rounded-2xl shadow-2xl w-[400px] animate-scale-in">
                        ...
                        <div className="space-y-3 text-gray-700 text-[15px]">
                            <div className="border-l-4 border-blue-500 pl-3">
                                <strong>Shartnoma raqami:</strong> {selectedTask.contract_info?.doc_num}
                            </div>
                            <div className="border-l-4 border-blue-500 pl-3">
                                <strong>Hamkor tashkilot:</strong> {selectedTask.contract_info?.organization}
                            </div>
                            <div className="border-l-4 border-green-500 pl-3">
                                <strong>Tadbir boshlanish vaqti:</strong> {selectedTask.contract_info?.start_date} {selectedTask.contract_info?.start_time}
                            </div>
                            <div className="border-l-4 border-red-500 pl-3">
                                <strong>Tadbir tugash vaqti:</strong> {selectedTask.contract_info?.end_date} {selectedTask.contract_info?.end_time}
                            </div>
                        </div>
                        ...
                        <tbody>
                            {data.map((task: any, index: number) => (
                                ...
                                >
                                    ...
                                    <td
                                        className={`px-4 py-3 text-center font-semibold ${task.status === "Muddati o'tgan"
                                            ? "text-red-600"
